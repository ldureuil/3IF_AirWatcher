...
public:
    ...
    // Si le fichier n'existe pas, il est créé avec l'userId donné en paramètre en lui donnant 10 points.
    ...
    // Mode d'emploi : Permet de changer le statut d'un utilisateur dans le fichier ParticulierData.csv, il devient exclu.
    //
    // Contrat : paramètre userId doit être une chaîne de caractères valide représentant
    // l'identifiant de l'utilisateur et se trouvant dans le fichier users.csv.
